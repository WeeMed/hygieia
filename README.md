...
[![Latest Release](https://img.shields.io/badge/release-v1.0.35-green.svg)](https://github.com/WeeMed/hygieia/releases/latest)
...
```bash
# Download binary
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.35/hygieia-linux-amd64
...
```bash
# Download binary
curl -LO https://github.com/WeeMed/hygieia/releases/download/v1.0.35/hygieia-darwin-arm64
...
```bash
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.35/checksums.txt
