...
[![Latest Release](https://img.shields.io/badge/release-v1.0.59-green.svg)](https://github.com/WeeMed/hygieia/releases/latest)
...
```bash
# Download binary
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.59/hygieia-linux-amd64
...
```bash
# Download binary
curl -LO https://github.com/WeeMed/hygieia/releases/download/v1.0.59/hygieia-darwin-arm64
...
```bash
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.59/checksums.txt
