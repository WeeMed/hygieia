...
[![Latest Release](https://img.shields.io/badge/release-v1.0.12-green.svg)](https://github.com/WeeMed/hygieia/releases/latest)
...
```bash
curl -fsSL https://raw.githubusercontent.com/WeeMed/hygieia/main/github/production/install.sh | sudo bash
```
...
```bash
# Download binary
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.12/hygieia-linux-amd64
...
```bash
# Download binary
curl -LO https://github.com/WeeMed/hygieia/releases/download/v1.0.12/hygieia-darwin-arm64
...
```bash
wget https://github.com/WeeMed/hygieia/releases/download/v1.0.12/checksums.txt
